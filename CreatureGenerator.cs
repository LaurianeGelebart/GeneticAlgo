...
public class CreatureGenerator : MonoBehaviour
{
    ...
    private Vector3 CreateBody(GameObject spherePrefab, Vector3 initialPosition, GameObject creatureModel, Creature creature)
    {
    ...
    private void CreateTentacles(GameObject spherePrefab, Vector3 initialPosition, GameObject creatureModel, Creature creature)
    {
    ...
    /// <param name="scaleFactor">Le facteur d'échelle de la créature</param>
    private void CreateTentacleSpheres(GameObject spherePrefab, Vector3 tentacleBasePosition, GameObject creatureModel, Creature creature, int tentacleLength, float scaleFactor)
    {
        Color creatureColor = creature.Color;
